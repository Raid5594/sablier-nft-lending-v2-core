...
const {
  abi: testAssetABI,
  bytecode: testAssetBytecode,
} = require("../artifacts/contracts/TestAssetNFT.sol/TestAssetNFT.json");
...
const polygonProvider = new ethers.providers.JsonRpcProvider(
  "https://polygon-mumbai.g.alchemy.com/v2/VLWsZk9tKHgYfF5kuBLPsq29N1nzAMLu",
); // Replace with your RPC URL, e.g., Infura, Alchemy, etc.
